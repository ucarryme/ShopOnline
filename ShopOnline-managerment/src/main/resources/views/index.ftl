...
<div class="wrapper">
  <header class="main-header">
      ...
      <a href="/index/Admin/Index/index" class="logo">
        ...
        <span class="logo-lg"><img src="${ctx}/static/images/ego_logo.png" width="40" height="30">&nbsp;&nbsp;<b>ShopOnline</b></span>
      </a>
	      ...
	      <li class="treeview">
	            ...
	            <ul class="treeview-menu">
	            	<li onclick="makecss(this)" data-id="categoryList_Goods">
	            		...
	            		<a href='${ctx}/goodsSelf/list' target='rightContent'><i class="fa fa-circle-o"></i>商品列表</a>
