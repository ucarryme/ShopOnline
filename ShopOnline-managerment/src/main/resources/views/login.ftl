...
<div class="login-box">
    ...
    <div class="margin text-center">
        <div class="copyright">
            2014-2016 &copy; <a href="http://www.ShopOnline.cn">ShopOnline v1.3.3</a>
            <br/>
            <a href="http://www.ShopOnline.cn">北京506网络有限公司</a>出品
        </div>
    </div>
</div><!-- /.login-box -->
<!-- jQuery 2.1.4 -->
