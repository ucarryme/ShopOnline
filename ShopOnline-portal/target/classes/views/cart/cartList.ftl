	...
	<div id="s_bdw">
		<div id="s_bd">
			...
			<div class="cartlist">
				<table width="100%">
					<tr>
						<th>购物车中的商品</th><th>ShopOnline价</th><th>购买数量</th><th>订单时间</th><th>操作</th>
					</tr>
					<tr bgcolor="#fffaf1">
						<td>
					...
					<tr>
						...
						<td>
							<div class="addinput">
								<input type="text" name="qty_item_2" value="1" id="qty_item_2" onblur="setAmount.modify('#qty_item_2')" class="stext"/>
