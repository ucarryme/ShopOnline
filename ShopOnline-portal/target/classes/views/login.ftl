...
<div id="doc">
	<div id="s_hdw">
		...
		<div id="s_tbar">
			<div class="s_hd">
				<div class="tbar_lft">您好，欢迎来到ShopOnline商城！<a href="#">请登录</a> | <a href="#">免费注册</a></div>
				<div class="tbar_rgt">
					<ul>
		...
		<div class="mmenu">
			<div class="s_hd">
				...
				<div id="s_cart">
					<ul>
						<li class="nums"><a href="${ctx}/cart/showCart" id="s_cart_nums1">购物车： <span>0</span>  件</a> <a href="" class="btn" id="s_cart_nums2"></a></li>
		...
		<div id="s_bd">
			...
			<div class="dl_zc">
				...
				<div class="dl-con cf" id="entry">
					<form id="formlogin" method="post" onsubmit="">
						...
						<div class="form" style="width:600px;">
							<div class="item">
								...
								<div class="fl">
									<input type="text" id="email" name="email" class="text" tabindex="1" value=""/>
							...
							<div class="item">
								<span class="label">&nbsp;</span>
								<input type="button" class="btnimg" id="loginsubmit" value="" tabindex="8" onclick="userLogin()"/>
							</div>
						...
						<!--form end-->
						<div id="guide">
							<h5>还不是ShopOnline商城用户？</h5>
		
							<div class="content">现在免费注册成为ShopOnline商城用户，便能立刻享受便宜又放心的购物乐趣。</div>
	...
	<div id="s_ftw">
		...
		<div id="s_ft">
			...
			<div class="copyright tac pbt10">版权所有 Copyright&copy; ShopOnline商城 All Rights Reserved 版权所有 </div>
